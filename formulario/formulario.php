...
if(count($_POST) > 0) {
  ...
  if(filter_input(INPUT_POST, 'nascimento')) {
    $nascimento = DateTime::createFromFormat('d/m/Y', $_POST['nascimento']);
    if(!$nascimento) {
...
<form action="#" method="post">
  <div class="form-row">
    <div class="form-group col-md-9 "> 
      ...
      <input type="text" class="form-control" id="nome" name="nome" placeholder="Insira o seu nome" value="<?= $_POST['nome']?>">
  ...
  <div class="form-row">
    <div class="form-group col-md-6"> 
      ...
      <input type="text" class="form-control <?= $erros['email'] ? 'is-invalid' : '' ?>" id="email" name="email" placeholder="exemplo@exemplo.com" value="<?= $_POST['email']?>">
    </div>
    <div class="form-group col-md-6"> 
  ...
  <div class="form-row">
    <div class="form-group col-md-6"> 
      ...
      <input type="number" class="form-control <?= $erros['filhos'] ? 'is-invalid' : '' ?>" id="filhos" name="filhos" placeholder="Qtd. Filhos" value="<?= $_POST['filhos']?>">
      <div class="invalid-feedback">
        <?= $erros['filhos']?>
      </div>
    </div>
